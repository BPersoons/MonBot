...
| **3 · proeftuin** | klein live, uit het verliesbudget | ≤ $250 totaal | de poort uit het register: aantal trades of dagen, geldmaat tegen de benchmark, gecorrigeerd voor beta |
...
2. **Het verliesbudget is gedeeld:** $250 voor alles op trede 3 samen, alarm bij $125. Maximaal
   **drie experimenten** tegelijk op trede 3, zodat elk genoeg budget heeft om iets te bewijzen.
...
## Hoe de motor zich verhoudt tot het VM-venster

Sinds het besluit van 21-09 draait de VM 12:30–21:30 UTC. Schaduw-experimenten die 24/7
data nodig hebben, draaien daarom in dat venster of in GitHub Actions (dat start uren te
laat, dus alleen voor trage strategieën — memory `reference_github_actions_vertraging`).
Trede 1 (papier) draait lokaal of in Actions.
